...
<table width="100%" class="header_table" style="margin: 0; padding: 0;" border="0">
    <tr>
        <td>
            <h2 class="text_center"><?php echo date("F jS", strtotime($page["date_saved"])) ?></h2>
            <h2 class="text_center">Week
                N° <?php echo date("W", strtotime($page["date_saved"])) . ",<br>" . date("Y", strtotime($page["date_saved"])) ?></h2>
        </td>
        <td>
        ...
        <td>
            ...
            <table width="100%" class="header_table" style="font-family: Mugglenews, arial, serif;">
                <td width="40%"
                    ...
                    ?>
                ><a href="preview.php?page_id=<?php echo $page_id - 1; ?>"><i
                ...
                <td width="30%"
                    ...
                    ?>
                ><a href="preview.php"><i class="fa fa-home"></i> Home</a></td>
                <td width="30%"
                    <?php
                    ...
                    ?>
                ><a href="preview.php?page_id=<?php echo $page_id + 1; ?>">Next <i
